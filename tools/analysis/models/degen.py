...
xs = ProcessVariable("xs", 0, 10, 0.5, "usteps", updateWeight=0.04)
xs_in = ProcessVariable("xs_in", 0, 0, 5, "usteps")
dxsdt = ProcessVariable("dxsdt", 0, 30, 0.15, "usteps/sec", updateWeight=0.8)
Ph = ProcessVariable("Ph", 0, 0, 0.9, "Pa", updateWeight=0.5)
Ph0 = ProcessVariable("Ph0", 4000, 400, 2, "Pa", updateWeight=1)
Ph_in = ProcessVariable("Ph_in", 0, 0, 2, "Pa")
Ps = ProcessVariable("Ps", 0, 0, 0.1, "Pa", updateWeight=0.35)
a1 = ProcessVariable("a1", 3, 1, 0.14, "Pa/(ustep/sec)", updateWeight=0.1)
a0 = ProcessVariable("a0", 0, 0, 10, "Pa", updateWeight=0.1)

# Level 1 Capacitance
Chl = ProcessVariable("Chl", 12, 0.2, 0.03, "Pa/ustep", updateWeight=0.03)

# Level 1 Shear Thinning
m = ProcessVariable("m", 0.6, 0.01, 0.006, "dimensionless", updateWeight=0.004)
gamma = ProcessVariable("gamma", 5, 0.1, 0.001, "idk", updateWeight=0.002)
